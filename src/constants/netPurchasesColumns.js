...
export const NET_PURCHASES_DEFAULT_COLUMNS = [
  ...
  { title: 'الإجمالي', key: 'total', width: 110, align: 'center', render: (_, r) => formatMoney((parseFloat(r['الكمية']) || 0) * (parseFloat(r['الافرادي']) || 0)) },
